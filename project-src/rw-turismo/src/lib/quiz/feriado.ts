...
// Nome e telefone sairam daqui para lib/quiz/contato.ts quando o quiz deixou de
// ser um so: as regras nao tem nada de especifico deste quiz. Reexportados para
// nao quebrar quem ja importava daqui — inclusive feriado.test.ts.
export {
  digitosDoTelefone,
  mascararTelefone,
  nomeValido,
